...
const definitions = {
  ...
  SerializedAddCategoryAppsAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "packageNames", "type"],
  },
  SerializedAddCategoryNetworkIdAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "hashedNetworkId", "itemId", "type"],
  },
  SerializedAddParentU2fKeyAction: {
    ...
    additionalProperties: false,
    required: ["keyHandle", "publicKey", "type"],
  },
  SerializedAddUserAction: {
    ...
    additionalProperties: false,
    required: ["name", "timeZone", "type", "userId", "userType"],
  },
  ...
  SerializedCreateCategoryAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "childId", "title", "type"],
  },
  ...
  SerializedTimeLimitRule: {
    ...
    additionalProperties: false,
    required: ["categoryId", "days", "extraTime", "ruleId", "time"],
  },
  ...
  SerializedIncrementCategoryExtraTimeAction: {
    ...
    additionalProperties: false,
    required: ["addedExtraTime", "categoryId", "type"],
  },
  ...
  SerializedSetCategoryExtraTimeAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "newExtraTime", "type"],
  },
  SerializedSetCategoryForUnassignedAppsAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "childId", "type"],
  },
  SerializedSetChildPasswordAction: {
    ...
    additionalProperties: false,
    required: ["childId", "newPassword", "type"],
  },
  ...
  SerializedSetDeviceDefaultUserAction: {
    ...
    additionalProperties: false,
    required: ["defaultUserId", "deviceId", "type"],
  },
  SerializedSetDeviceDefaultUserTimeoutAction: {
    ...
    additionalProperties: false,
    required: ["deviceId", "timeout", "type"],
  },
  ...
  SerializedSetKeepSignedInAction: {
    ...
    additionalProperties: false,
    required: ["deviceId", "keepSignedIn", "type"],
  },
  SerializedSetParentCategoryAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "parentCategory", "type"],
  },
  ...
  SerializedUpdateCategoryBlockAllNotificationsAction: {
    ...
    additionalProperties: false,
    required: ["blockDelay", "blocked", "categoryId", "type"],
  },
  SerializedUpdateCategoryBlockedTimesAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "times", "type"],
  },
  SerializedUpdatCategoryDisableLimitsAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "endTime", "type"],
  },
  SerializedUpdateCategoryFlagsAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "modified", "type", "values"],
  },
  ...
  SerializedUpdateCategoryTemporarilyBlockedAction: {
    ...
    additionalProperties: false,
    required: ["blocked", "categoryId", "type"],
  },
  SerializedUpdateCategoryTimeWarningsAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "enable", "flags", "type"],
  },
  SerializedUpdateCategoryTitleAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "newTitle", "type"],
  },
  ...
  SerializedUpdateParentNotificationFlagsAction: {
    ...
    additionalProperties: false,
    required: ["flags", "parentId", "set", "type"],
  },
  SerializedUpdateTimelimitRuleAction: {
    ...
    additionalProperties: false,
    required: ["days", "extraTime", "ruleId", "time", "type"],
  },
  SerializedUpdateUserFlagsAction: {
    ...
    additionalProperties: false,
    required: ["modified", "type", "userId", "values"],
  },
  ...
  SerializedUpdateUserLimitLoginPreBlockDuration: {
    ...
    additionalProperties: false,
    required: ["preBlockDuration", "type", "userId"],
  },
  ...
  SerializedAddUsedTimeAction: {
    ...
    additionalProperties: false,
    required: ["categoryId", "day", "extraTimeToSubtract", "timeToAdd", "type"],
  },
  ...
  SerializedReplyToKeyRequestAction: {
    ...
    additionalProperties: false,
    required: ["encryptedKey", "rsn", "signature", "tempKey", "type"],
  },
  SerializedSendKeyRequestAction: {
    ...
    additionalProperties: false,
    required: ["dataType", "dsn", "signature", "tempKey", "type"],
  },
  ...
  SerializedUpdateAppActivitiesAction: {
    ...
    additionalProperties: false,
    required: ["removed", "type", "updatedOrAdded"],
  },
  ...
  ServerKeyResponse: {
    ...
    additionalProperties: false,
    required: ["cryptKey", "rqSeq", "sender", "signature", "srvSeq", "tempKey"],
  },
  ServerDhKey: {
    type: "object",
    properties: {
...
export const isClientPushChangesRequest: (
  value: unknown,
) => value is ClientPushChangesRequest = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
...
export const isClientPullChangesRequest: (
  value: unknown,
) => value is ClientPullChangesRequest = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
...
export const isMailAuthTokenRequestBody: (
  value: unknown,
) => value is MailAuthTokenRequestBody = ajv.compile({
  type: "object",
  properties: {
    mailAuthToken: {
      type: "string",
...
export const isCreateFamilyByMailTokenRequest: (
  value: unknown,
) => value is CreateFamilyByMailTokenRequest = ajv.compile({
  type: "object",
  properties: {
    mailAuthToken: {
      type: "string",
...
export const isSignIntoFamilyRequest: (
  value: unknown,
) => value is SignIntoFamilyRequest = ajv.compile({
  type: "object",
  properties: {
    mailAuthToken: {
      type: "string",
  ...
  additionalProperties: false,
  required: ["deviceName", "mailAuthToken", "parentDevice"],
  definitions: definitions,
  $schema: "http://json-schema.org/draft-07/schema#",
})
export const isRecoverParentPasswordRequest: (
  value: unknown,
) => value is RecoverParentPasswordRequest = ajv.compile({
  type: "object",
  properties: {
    mailAuthToken: {
      type: "string",
...
export const isRegisterChildDeviceRequest: (
  value: unknown,
) => value is RegisterChildDeviceRequest = ajv.compile({
  type: "object",
  properties: {
    registerToken: {
      type: "string",
  ...
  additionalProperties: false,
  required: ["childDevice", "deviceName", "registerToken"],
  definitions: definitions,
  $schema: "http://json-schema.org/draft-07/schema#",
})
export const isSerializedParentAction: (
  value: unknown,
) => value is SerializedParentAction = ajv.compile({
  anyOf: [
    {
...
export const isSerializedAppLogicAction: (
  value: unknown,
) => value is SerializedAppLogicAction = ajv.compile({
  anyOf: [
    {
...
export const isSerializedChildAction: (
  value: unknown,
) => value is SerializedChildAction = ajv.compile({
  anyOf: [
    {
...
export const isCreateRegisterDeviceTokenRequest: (
  value: unknown,
) => value is CreateRegisterDeviceTokenRequest = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
...
export const isCanDoPurchaseRequest: (
  value: unknown,
) => value is CanDoPurchaseRequest = ajv.compile({
  type: "object",
  properties: {
    type: {
      enum: ["any", "googleplay"],
...
export const isFinishPurchaseByGooglePlayRequest: (
  value: unknown,
) => value is FinishPurchaseByGooglePlayRequest = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
...
export const isLinkParentMailAddressRequest: (
  value: unknown,
) => value is LinkParentMailAddressRequest = ajv.compile({
  type: "object",
  properties: {
    mailAuthToken: {
      type: "string",
...
export const isUpdatePrimaryDeviceRequest: (
  value: unknown,
) => value is UpdatePrimaryDeviceRequest = ajv.compile({
  type: "object",
  properties: {
    action: {
      enum: ["set this device", "unset this device"],
      type: "string",
    },
    currentUserId: {
      type: "string",
  ...
  additionalProperties: false,
  required: ["action", "authToken", "currentUserId"],
  $schema: "http://json-schema.org/draft-07/schema#",
})
export const isRemoveDeviceRequest: (
  value: unknown,
) => value is RemoveDeviceRequest = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
...
export const isRequestIdentityTokenRequest: (
  value: unknown,
) => value is RequestIdentityTokenRequest = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
...
export const isRequestWithAuthToken: (
  value: unknown,
) => value is RequestWithAuthToken = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
  ...
  additionalProperties: false,
  required: ["deviceAuthToken"],
  $schema: "http://json-schema.org/draft-07/schema#",
})
export const isSendMailLoginCodeRequest: (
  value: unknown,
) => value is SendMailLoginCodeRequest = ajv.compile({
  type: "object",
  properties: {
    mail: {
      type: "string",
  ...
  additionalProperties: false,
  required: ["locale", "mail"],
  $schema: "http://json-schema.org/draft-07/schema#",
})
export const isSignInByMailCodeRequest: (
  value: unknown,
) => value is SignInByMailCodeRequest = ajv.compile({
  type: "object",
  properties: {
    mailLoginToken: {
      type: "string",
  ...
  additionalProperties: false,
  required: ["mailLoginToken", "receivedCode"],
  $schema: "http://json-schema.org/draft-07/schema#",
})
export const isIdentityTokenPayload: (
  value: unknown,
) => value is IdentityTokenPayload = ajv.compile({
  additionalProperties: false,
  type: "object",
  properties: {
    purpose: {
...
export const isDeleteAccountPayload: (
  value: unknown,
) => value is DeleteAccountPayload = ajv.compile({
  type: "object",
  properties: {
    deviceAuthToken: {
      type: "string",
